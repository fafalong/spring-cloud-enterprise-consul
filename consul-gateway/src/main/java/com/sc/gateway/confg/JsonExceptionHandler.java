...
/**
 * @classDesc: 统一异常处理,
 *             参考{@link org.springframework.web.server.AbstractErrorWebExceptionHandler}修改

not used here, default from gateway: 
{"timestamp":"2019-04-18T06:36:36.136+0000","status":500,"error":"Internal Server Error","message":"/ by zero","path":"/err1"}
...
public class JsonExceptionHandler implements ErrorWebExceptionHandler {
	...
	public Mono<Void> handle(ServerWebExchange exchange, Throwable ex) {
		...
		if (ex instanceof NotFoundException) {
			...
			body = "Internal Server Error: " + ex.toString();
		}
		/**
